...
let person1 = new Person('Axel',99);
document.write("Hello "+ person1.name+"<br>");
let business = new Enterprise(person1.age);

document.write("<br>");
document.write("<br>");

let person2 = new Person('Ricardo',19);
document.write("Hello "+ person2.name+"<br>");
let business1 = new Enterprise(person2.age);
